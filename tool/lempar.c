...
*/
struct yyStackEntry {
  int stateno;  /* The state-number, or reduce action in SHIFTREDUCE */
...
*/
static void *ParseAlloc(void *(*mallocProc)(YYMALLOCARGTYPE) ParseCTX_PDECL){
  yyParser *yypParser;
...
static void Parse(
  ...
  while(1){ /* Exit by "break" */
    ...
    if( yyact >= YY_MIN_REDUCE ){
      ...
      */
      yy_syntax_error(yypParser,yymajor, yyminor);
      yy_destructor(yypParser,yymajor,(YYMINORTYPE*)yyminor);
      break;
